...
mixin _$ProductInfoDto {
  ...
  int? get saleRate => throw _privateConstructorUsedError;
...
abstract class $ProductInfoDtoCopyWith<$Res> {
  factory $ProductInfoDtoCopyWith(
    ProductInfoDto value,
    $Res Function(ProductInfoDto) then,
...
abstract class _$$ProductInfoDtoImplCopyWith<$Res>
    implements $ProductInfoDtoCopyWith<$Res> {
  factory _$$ProductInfoDtoImplCopyWith(
    _$ProductInfoDtoImpl value,
...
class __$$ProductInfoDtoImplCopyWithImpl<$Res>
  ...
  __$$ProductInfoDtoImplCopyWithImpl(
    _$ProductInfoDtoImpl _value,
    $Res Function(_$ProductInfoDtoImpl) _then,
  ) : super(_value, _then);
...
class _$ProductInfoDtoImpl implements _ProductInfoDto {
  ...
  @override
  String toString() {
    return 'ProductInfoDto(productId: $productId, title: $title, subtitle: $subtitle, imageUrl: $imageUrl, price: $price, originalPrice: $originalPrice, saleRate: $saleRate, reviewCount: $reviewCount)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ProductInfoDtoImplToJson(this);
  }
}
