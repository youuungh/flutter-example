...
/// @nodoc
@JsonSerializable()
class _$ProductInfoImpl with DiagnosticableTreeMixin implements _ProductInfo {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProductInfo(productId: $productId, title: $title, subtitle: $subtitle, imageUrl: $imageUrl, price: $price, originalPrice: $originalPrice, saleRate: $saleRate, reviewCount: $reviewCount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, productId, title, subtitle,
      imageUrl, price, originalPrice, saleRate, reviewCount);
